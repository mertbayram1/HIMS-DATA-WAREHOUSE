...
CREATE TABLE dim_patient (
    ...
    gender TEXT NOT NULL CHECK (gender IN ('E', 'K', 'D')),
    birth_date TEXT NOT NULL,
    insurance_type TEXT NOT NULL CHECK (insurance_type IN ('SGK', 'Özel', 'Diğer')),
    city TEXT NOT NULL,
...
CREATE TABLE dim_doctor (
    ...
    title TEXT NOT NULL CHECK (title IN ('Prof. Dr.', 'Doç. Dr.', 'Uzman Dr.', 'Dr.')),
...
CREATE TABLE fact_appointment (
    ...
    department_key INTEGER NOT NULL,
    appointment_status TEXT NOT NULL CHECK (appointment_status IN ('PLANLI', 'TAMAMLANDI', 'İPTAL', 'GELMEDİ')),
